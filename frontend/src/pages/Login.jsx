              ...
              <form className="w-full max-w-lg" onSubmit={handleLogin}>
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  <div className="w-full px-3">
                    ...
                    <select value={role} onChange={(e) => setRole(e.target.value)} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-role">
                ...
                <button className="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded justify-center" type="submit">
                  Login
                </button>
              </form>
            </div>
